document.addEventListener("DOMContentLoaded", () => {
  ...
  async function renderList() {
    ...
    const apiUrl =
      "https://crudcrud.com/api/3d7204c49c774672ba41a7960a3158c8/productlist";
  ...
  async function deleteList(list_Id, element) {
    const apiUrl = `https://crudcrud.com/api/3d7204c49c774672ba41a7960a3158c8/productlist/${list_Id}`;
